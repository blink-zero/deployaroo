document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('saveDomainNameBtn').addEventListener('click', handleSaveDomainName);
    ...
    function handleCreateVmButton(event) {
        ...
        const domainControllerImages = [
            'windows-server-2022-datacenter-dexp-v23.01|win_server2022dc_de_ad|windows9Server64Guest|Windows Server 2022 Desktop Experience - Domain Controller|WIN.png'
        ];
